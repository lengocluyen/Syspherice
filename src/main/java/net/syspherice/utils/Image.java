...
public class Image {
   ...
   *   position. This method can also be used to create image mosiacs.
   */    
    public void addImage(net.syspherice.utils.Image in, int x, int y, boolean expand){ 
   ...
   */
    public boolean equals(Object obj){
        if (obj!=null){
            if (obj instanceof net.syspherice.utils.Image){
            	net.syspherice.utils.Image image = (net.syspherice.utils.Image) obj;
...
private class Skew {
    ...
    public Skew(net.syspherice.utils.Image src) {
