...
<c:if test="${!empty noticefail}">
	<div class="alert alert-danger">
		<strong>Error Import data! ${message}</strong>
	</div>
</c:if>

<form:form class="import-form" method="post" 
	action='${pageContext.request.contextPath}/exceldatadoc/update/${sessionScope.ExcelDataDoc.textDataDocID}'
	...
	<div class="row">
		<div class="import-page-content">
			<div class="import-heading">
				<h2 style="padding:0px;margin:0px;">Update project information with data from a file Excel</h2>
				<p>To update information project to database. We have to fill up
			...
			<div class="import-form clearfix">
				...
				<p class="full-row">
					...
					<form:textarea path="description" row="75" />
				</p>
				<p class="full-row">
