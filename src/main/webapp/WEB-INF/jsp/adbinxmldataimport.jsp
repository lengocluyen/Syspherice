...
<form:form class="import-form" method="post"
	action='${pageContext.request.contextPath}/binxmldata/import'
	...
	<div class="row">
		<div class="import-page-content">
			<div class="import-heading">
				<h2 style="padding: 0px; margin: 0px;">Import xml file of project</h2>
				<p>To import xml data to database. We have to fill up
			...
			<div class="import-form clearfix">
				...
				<p class="full-row">
					...
					<span class="small-text">Choose folder Xml</span>
					</span>
