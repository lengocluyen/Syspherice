								...
								<div class="gallery-item" style="margin-top: 15px;">
									<a class="fancybox" rel="gallery1"
										...
										<div class="gallery-thumb">
											<img src="${pageContext.request.contextPath}/${data.url}"
												alt="">
										</div>
									...
									<div style="float:right; width:45%;">	
										...
										onclick="window.location.href='${pageContext.request.contextPath}/imagedata/delete/${data.imageID}';">	
								</div>
						...
						<c:forEach var="i" items="${ulist.nav.indexList}">
							<c:choose>
								<c:when test="${i != ulist.nav.currentPage}">
									<a
										href="${pageContext.request.contextPath}/imagedata/index/${i}">${i}</a>&nbsp;
					</c:when>
								<c:otherwise>
									<b>${i}</b>&nbsp;
					</c:otherwise>
